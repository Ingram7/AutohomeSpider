...
class RedisStartUrlsPipeline(object):
    ...
    def process_item(self, item, spider):
        if type(item).__name__ == 'AutohomespiderItem':
            redis_key = 'koubei_spider:start_urls'
...
class MongoPipeline(object):
    ...
    def process_item(self, item, spider):
        self.db[self.collection_name].update({'Koubeiid': item['Koubeiid']}, {'$set': item}, True)
        return item